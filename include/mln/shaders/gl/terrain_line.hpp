...
template <>
struct ShaderSource<BuiltIn::TerrainLineShader, gfx::Backend::Type::OpenGL> {
    static constexpr const char* name = "TerrainLineShader";
    static constexpr const char* vertex = R"(// DuckMaps fork only. Ported from the web engine's routes3d.js VS (routes3d.js:375-391, quoted
...
void main() {
    ...
    static constexpr const char* fragment = R"(// DuckMaps fork only. Ported from the web engine's routes3d.js FS (routes3d.js:392-422, quoted
