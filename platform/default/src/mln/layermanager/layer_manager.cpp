...
#endif
#if !defined(MBGL_LAYER_SLOPE_SHADING_DISABLE_ALL)
    // DuckMaps fork only, task 2.6 - slope/aspect area fill, same shape as terrain-contour.
    addLayerType(std::make_unique<SlopeShadingLayerFactory>());
#endif
}
